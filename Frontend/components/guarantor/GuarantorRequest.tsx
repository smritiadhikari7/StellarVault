...
const REGISTRY: MockGuarantor[] = [
  {
    id: "rohan_das",
    name: "Rohan Das",
    wallet: "GB837A8F92B7C52A019D384FE572B683E91122B29B",
    score: 812,
    kycLevel: 2,
    activeGuarantees: 0,
  },
  {
    id: "priya_patel",
    name: "Priya Patel",
    wallet: "GB771C8F92B7C52A019D384FE572B683E91122B29C",
    score: 790,
    kycLevel: 2,
    activeGuarantees: 1,
  },
  {
    id: "neha_roy",
    name: "Neha Roy",
    wallet: "GB911E8F92B7C52A019D384FE572B683E91122B29D",
    score: 825,
    kycLevel: 2,
    activeGuarantees: 0,
  },
  {
    id: "vikram_sen",
    name: "Vikram Sen",
    wallet: "GB111A8F92B7C52A019D384FE572B683E91122B29E",
    score: 580,
    kycLevel: 2,
    activeGuarantees: 0,
  },
  {
    id: "suresh_nair",
    name: "Suresh Nair",
    wallet: "GB222B8F92B7C52A019D384FE572B683E91122B29F",
    score: 712,
    kycLevel: 1,
    activeGuarantees: 0,
  },
  {
    id: "tanya_sharma",
    name: "Tanya Sharma",
    wallet: "GB333C8F92B7C52A019D384FE572B683E91122B29G",
    score: 892,
    kycLevel: 3,
    activeGuarantees: 2,
  },
  {
    id: "arjun_sharma",
    name: "Arjun Sharma",
    wallet: "GB7F3A8F92B7C52A019D384FE572B683E91122B29C",
    score: 847,
    kycLevel: 2,
    activeGuarantees: 0,
  },
  ...
  const handleCheckAndSubmit = (e: React.FormEvent) => {
    ...
    const match = REGISTRY.find(
      (g) =>
        ...
        g.wallet.toLowerCase() === normalizedQuery,
    );

    if (!match) {
      setErrorMsg("User not found in StellarVault X directory.");
      return;
    }
    ...
    if (
      match.id === "arjun_sharma" ||
      match.wallet === "GB7F3A8F92B7C52A019D384FE572B683E91122B29C"
    ) {
      setErrorMsg(
        "You cannot act as your own guarantor. Please search for a distinct user.",
      );
      return;
    }
    ...
    if (match.score < 600) {
      setErrorMsg(
        `This user's Trust Score is too low to be a guarantor (${match.score} < 600).`,
      );
      return;
    }
    ...
    if (match.kycLevel < 2) {
      setErrorMsg(
        "This user has not completed KYC Level 2 verification (Identity verification is required).",
      );
      return;
    }
    ...
    if (match.activeGuarantees >= 2) {
      setErrorMsg(
        "This user is already guaranteeing 2 active loans (maximum limit reached).",
      );
      return;
    }
    ...
    <div className="space-y-4">
          ...
          <div className="flex items-start gap-2.5">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-text-secondary leading-normal font-medium">
                Sent verification request to <strong>{requestedName}</strong>.
                They have 48 hours to confirm the credit risk lock.
              </p>
            </div>
          </div>

          <div className="flex items-center justify-between border-t border-amber-100/50 pt-2.5">
            <span className="text-[10px] text-warning uppercase font-bold tracking-wider">
              Time Remaining:
            </span>
      ...
      {!isPending && (
        <div className="p-3 bg-slate-50 border border-slate-100 rounded-xl text-[10px] text-text-secondary leading-normal space-y-1 font-medium">
          ...
          <p>
            Eligible: <span className="font-mono">rohan_das</span>,{" "}
            <span className="font-mono">priya_patel</span>,{" "}
            <span className="font-mono">neha_roy</span>
          </p>
          <p>
            Low Score (&lt;600): <span className="font-mono">vikram_sen</span>{" "}
            (580)
          </p>
          <p>
            Low KYC (&lt;Lvl 2): <span className="font-mono">suresh_nair</span>{" "}
            (Level 1)
          </p>
          <p>
            Guarantees Maxed (2/2):{" "}
            <span className="font-mono">tanya_sharma</span>
          </p>
        </div>
      )}
    </div>
