// StellarVault X Mock Data Store
...
export const kycTimeline = [
  {
    event: "Level 1 completed",
    date: "Sep 10, 2025",
    impact: "+10 pts",
    status: "success",
  },
  {
    event: "Level 2 completed",
    date: "Sep 20, 2025",
    impact: "+15 pts",
    status: "success",
  },
  {
    event: "Level 3 submitted",
    date: "Nov 18, 2025",
    impact: "Pending",
    status: "warning",
  },
...
export const fraudAlerts = [
  {
    id: "ALT-1",
    type: "⚠️ Suspicious wallet behavior",
    detail: "3 linked sub-accounts created on same IP within 5 mins.",
    score: "Avg 490",
    action: "Flagged",
  },
  {
    id: "ALT-2",
    type: "⚠️ Rapid collateral depletion",
    detail: "Collateralized balance on-chain fell below 2% of debt limit.",
    score: "Avg 580",
    action: "Review",
  },
];
