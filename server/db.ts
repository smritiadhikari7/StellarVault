...
const MONGODB_URI =
  ...
  "mongodb://localhost:27017/StellarVault";
...
const seedDatabase = async () => {
  ...
  const seedUsers = [
    ...
    {
      walletAddress: "GB444D8F92B7C52A019D384FE572B683E91122B29H",
      name: "Aarav Mehta",
      trustScore: 968,
      kycLevel: 3,
      walletAge: "4.1 yrs",
      repaymentRate: 100,
      socialTrustScore: 100,
      aiRiskLevel: "Low" as const,
      creditLimit: 100000,
    },
    {
      walletAddress: "GB555E8F92B7C52A019D384FE572B683E91122B29I",
      name: "Zara Sheikh",
      trustScore: 942,
      kycLevel: 3,
      walletAge: "3.5 yrs",
    ...
    {
      walletAddress: "GB666F8F92B7C52A019D384FE572B683E91122B29J",
      name: "Devansh Bhatia",
      trustScore: 915,
      kycLevel: 3,
      walletAge: "3.0 yrs",
    ...
    {
      walletAddress: "GB777G8F92B7C52A019D384FE572B683E91122B29K",
      name: "Ananya Iyer",
      trustScore: 898,
      kycLevel: 2,
      walletAge: "2.8 yrs",
    ...
    {
      walletAddress: "GB888H8F92B7C52A019D384FE572B683E91122B29L",
      name: "Kunal Kapoor",
      trustScore: 885,
      kycLevel: 2,
      walletAge: "2.2 yrs",
    ...
    {
      walletAddress: "GB999I8F92B7C52A019D384FE572B683E91122B29M",
      name: "Riya Verma",
      trustScore: 860,
      kycLevel: 2,
      walletAge: "2.1 yrs",
    ...
    {
      walletAddress: "GB444D8F92B7C52A019D384FE572B683E91122B29AA",
      name: "Amit Kumar",
      trustScore: 821,
      kycLevel: 3,
      walletAge: "2.0 yrs",
    ...
    {
      walletAddress: "GB555E8F92B7C52A019D384FE572B683E91122B29BB",
      name: "Preeti Singh",
      trustScore: 540,
      kycLevel: 1,
      walletAge: "0.6 yrs",
    ...
    {
      walletAddress: "GB666F8F92B7C52A019D384FE572B683E91122B29CC",
      name: "Kiran Joshi",
      trustScore: 480,
      kycLevel: 1,
      walletAge: "0.5 yrs",
  ...
  const seedUsersWithPasswords = seedUsers.map((u) => ({
    ...u,
  ...
  const seedTransactions = [
    ...
    },
    {
      id: "TX-8802",
      walletAddress: "GB7F3A8F92B7C52A019D384FE572B683E91122B29C",
      type: "Social endorsement received",
      amount: "—",
      date: "Sep 28, 2025",
      status: "Completed" as const,
      impact: "+8 pts",
    ...
    },
    {
      id: "TX-8501",
      walletAddress: "GB7F3A8F92B7C52A019D384FE572B683E91122B29C",
      type: "First wallet link verified",
      amount: "—",
      date: "Sep 10, 2025",
      status: "Completed" as const,
      impact: "+10 pts",
  ...
  const seedEndorsements = [
    {
      ...
      date: "Nov 14, 2025",
      impact: "+5 pts",
      comment: "Outstanding repayment record in local lending circles.",
    },
    {
      id: "END-2",
      walletAddress: "GB7F3A8F92B7C52A019D384FE572B683E91122B29C",
      ...
      date: "Nov 10, 2025",
      impact: "+4 pts",
      comment: "Trusted community developer and stellar node builder.",
    },
    {
      id: "END-3",
      walletAddress: "GB7F3A8F92B7C52A019D384FE572B683E91122B29C",
      name: "Stellar India DAO",
      score: 890,
      date: "Oct 28, 2025",
      impact: "+12 pts",
      comment: "Active DAO participant with verified on-chain contributions.",
    },
  ];
